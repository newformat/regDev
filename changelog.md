...
- 1.4.12 - 20.12.19; обновлена система статистики: детали запуска, список запусков по месяцам; прочие правки и дополнения в коде; добавлены новые каталоги и система шаблонов
- 1.4.13 - 20.12.19; введена конфигурация настройки путей к файлам
- 1.4.14 - 21.12.19; введена возможность удалять все предыдущие файлы attach-unregistered-device-events перед удалением самого нового